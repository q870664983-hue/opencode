...
export const dict = {
  ...
  "dialog.provider.opencode.note": "使用 SineCode Zen 或 API 密钥连接",
  ...
  "dialog.model.unpaid.freeModels.title": "SineCode 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 SineCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "SineCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 SineCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 SineCode 中使用 {{provider}} 模型。",
  ...
  "session.child.promptDisabled": "子智能体会话暂时不能直接继续提问。",
  ...
  "dialog.server.description": "切换此应用连接的 SineCode 服务器。",
  ...
  "toast.update.description": "SineCode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 SineCode 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: SineCode 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "SineCode 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 SineCode 服务器。",
  ...
  "settings.general.row.language.description": "更改 SineCode 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 SineCode 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 SineCode 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 SineCode 的主题。",
  ...
  "settings.updates.row.startup.description": "在 SineCode 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 SineCode。",
  ...
  "settings.agents.description": "在这里统一管理主对话智能体与专业分工智能体，隐藏智能体不会铺在主对话界面。",
  "settings.agents.summary.main": "主对话",
  "settings.agents.summary.specialists": "专业分工",
  "settings.agents.summary.hidden": "隐藏项",
  "settings.agents.section.main.title": "主对话智能体",
  "settings.agents.section.main.description": "这些智能体保留在常规对话工作流中使用。",
  "settings.agents.section.specialists.title": "专业分工智能体",
  "settings.agents.section.specialists.description": "这些智能体主要服务于委派执行和多智能体编排流程。",
  "settings.agents.section.hidden.title": "隐藏智能体",
  "settings.agents.section.hidden.description": "这些智能体不会出现在主表面，只在这里集中管理。",
  "settings.agents.empty.main": "当前没有可用的主对话智能体。",
  "settings.agents.empty.specialists": "当前没有可用的专业分工智能体。",
  "settings.agents.empty.hidden": "当前没有配置隐藏智能体。",
  "settings.agents.badge.native": "内置",
  "settings.agents.badge.hidden": "隐藏",
  "settings.agents.badge.mode.primary": "主智能体",
  "settings.agents.badge.mode.all": "共享",
  "settings.agents.badge.mode.subagent": "专业分工",
  "settings.agents.badge.variant": "变体 {{variant}}",
  "settings.agents.badge.steps": "{{count}} 步",
  "settings.agents.workspace.empty.title": "先打开一个工作区会话再查看智能体配置",
  "settings.agents.workspace.empty.description":
    "智能体配置会按当前工作区解析。先进入任意项目对话，再回到这里查看或调整该工作区下的智能体集合。",
  "settings.agents.detail.empty.title": "选择一个智能体",
  "settings.agents.detail.empty.description":
    "从左侧选择一个智能体后，可以查看它的定位、模型、编排方式，以及后续可编辑的配置分区。",
  "settings.agents.detail.preview.title": "配置预览",
  "settings.agents.detail.preview.description":
    "这个详情面板是后续“可编辑智能体设置”的基础版本。当前先验证信息结构和字段分组是否合理。",
  "settings.agents.detail.section.identity": "基础身份",
  "settings.agents.detail.section.model": "模型与推理",
  "settings.agents.detail.section.orchestration": "编排与上下文",
  "settings.agents.detail.row.name": "名称",
  "settings.agents.detail.row.description": "描述",
  "settings.agents.detail.row.source": "来源",
  "settings.agents.detail.row.surface": "界面位置",
  "settings.agents.detail.row.model": "模型",
  "settings.agents.detail.row.variant": "变体",
  "settings.agents.detail.row.steps": "步骤预算",
  "settings.agents.detail.row.invocation": "调用模式",
  "settings.agents.detail.row.autoPlan": "参与自动规划",
  "settings.agents.detail.row.directSelection": "支持手动选择",
  "settings.agents.detail.row.tools": "工具策略",
  "settings.agents.detail.row.memory": "记忆策略",
  "settings.agents.detail.value.enabled": "启用",
  "settings.agents.detail.value.disabled": "停用",
  "settings.agents.detail.value.source.native": "内置模板",
  "settings.agents.detail.value.source.custom": "自定义智能体",
  "settings.agents.detail.value.surface.main": "主对话表面",
  "settings.agents.detail.value.surface.specialist": "仅专业分工",
  "settings.agents.detail.value.surface.hidden": "隐藏于主表面",
  "settings.agents.detail.value.model.default": "跟随工作区默认模型",
  "settings.agents.detail.value.steps.inherit": "继承工作区默认值",
  "settings.agents.detail.value.tools.workspaceDefault": "遵循工作区默认工具策略",
  "settings.agents.detail.value.tools.customized": "使用自定义工具策略",
  "settings.agents.detail.value.memory.conversation": "会话与项目记忆",
  "settings.agents.detail.value.memory.projectShared": "项目共享记忆",
  "settings.agents.detail.value.memory.delegated": "聚焦项目与任务记忆",
  "settings.agents.detail.value.memory.disabled": "已关闭",
  "settings.agents.manage.open": "编辑智能体",
  "settings.agents.manage.title": "管理智能体",
  "settings.agents.manage.description": "修改已有智能体、添加自定义智能体，或停用当前工作区不需要的智能体。",
  "settings.agents.manage.add": "新增智能体",
  "settings.agents.manage.listTitle": "已配置智能体",
  "settings.agents.manage.custom": "自定义",
  "settings.agents.manage.new": "新智能体",
  "settings.agents.manage.nativeReadonly": "内置智能体",
  "settings.agents.manage.form.newDescription": "为当前工作区创建一个新的自定义智能体。",
  "settings.agents.manage.form.nativeDescription":
    "这里可以覆写内置智能体配置。删除内置智能体会以“停用”的方式写入当前工作区配置。",
  "settings.agents.manage.form.customDescription": "这里可以编辑或删除当前工作区的自定义智能体。",
  "settings.agents.manage.scopeNote": "这里的改动只会作用于当前工作区。",
  "settings.agents.manage.tab.identity": "基础信息",
  "settings.agents.manage.tab.execution": "执行配置",
  "settings.agents.manage.tab.memory": "记忆设置",
  "settings.agents.manage.overview.source": "来源",
  "settings.agents.manage.overview.mode": "调用方式",
  "settings.agents.manage.overview.surface": "界面位置",
  "settings.agents.manage.overview.override.label": "覆写状态",
  "settings.agents.manage.overview.override.default": "工作区默认",
  "settings.agents.manage.overview.override.workspace": "工作区覆写",
  "settings.agents.manage.overview.memory": "记忆",
  "settings.agents.manage.field.key.label": "标识符",
  "settings.agents.manage.field.key.description": "用于编排和命令调用的稳定智能体 id。",
  "settings.agents.manage.field.description.label": "描述",
  "settings.agents.manage.field.description.description": "说明这个智能体适合在什么情况下使用。",
  "settings.agents.manage.field.mode.label": "模式",
  "settings.agents.manage.field.hidden.label": "从主界面隐藏",
  "settings.agents.manage.field.hidden.description": "隐藏后仍可参与自动编排，但不会出现在主对话选择器中。",
  "settings.agents.manage.field.model.label": "模型覆写",
  "settings.agents.manage.field.model.description": "为这个智能体单独指定 provider/model。",
  "settings.agents.manage.field.variant.label": "变体",
  "settings.agents.manage.field.variant.description": "为这个智能体单独指定模型变体。",
  "settings.agents.manage.field.steps.label": "步骤数",
  "settings.agents.manage.field.steps.description": "这个智能体的最大执行步数预算。",
  "settings.agents.manage.field.prompt.label": "系统提示词覆写",
  "settings.agents.manage.field.prompt.description": "为这个智能体单独指定系统提示词。",
  "settings.agents.manage.field.memory.label": "项目记忆访问",
  "settings.agents.manage.field.memory.description": "控制这个智能体在 SineFlow 自动编排时是否读取工作区共享记忆。",
  "settings.agents.manage.field.memory.mode.inherit": "继承默认行为",
  "settings.agents.manage.field.memory.mode.projectShared": "读取项目共享记忆",
  "settings.agents.manage.field.memory.mode.disabled": "不读取共享记忆",
  "settings.agents.manage.field.memory.sourceTitle": "共享记忆来源",
  "settings.agents.manage.field.memory.sourceDescription":
    "启用后，SineFlow 会从当前工作区里优先读取第一个存在的共享记忆文件。",
  "settings.agents.manage.field.memory.behaviorTitle": "当前行为说明",
  "settings.agents.manage.field.memory.behaviorDescription":
    "这个设置只影响 SineFlow 自动规划执行，不会为每个智能体单独创建长期记忆库。",
  "settings.agents.manage.delete.nativeTitle": "停用内置智能体",
  "settings.agents.manage.delete.nativeDescription": "这会写入工作区覆写配置，让这个内置智能体不再出现在可用列表中。",
  "settings.agents.manage.delete.customTitle": "删除自定义智能体",
  "settings.agents.manage.delete.customDescription": "这会写入工作区覆写配置，让这个自定义智能体不再出现在可用列表中。",
  "settings.agents.manage.delete.disable": "停用",
  "settings.agents.manage.delete.remove": "删除",
  "settings.agents.manage.currentResolved": "当前解析后的说明",
  "settings.agents.manage.toast.saved.title": "智能体已保存",
  "settings.agents.manage.toast.saved.description": "{{agent}} 已更新。",
  "settings.agents.manage.toast.saveFailed.title": "保存智能体失败",
  "settings.agents.manage.toast.deleted.title": "智能体已移除",
  "settings.agents.manage.toast.deleted.description": "{{agent}} 已从当前工作区移除。",
  "settings.agents.manage.toast.deleteFailed.title": "移除智能体失败",
  "settings.agents.manage.validation.key.required": "必须填写标识符。",
  "settings.agents.manage.validation.key.format": "请使用小写字母、数字和连字符，并且以字母或数字开头。",
  "settings.agents.manage.validation.key.duplicate": "这个标识符已经存在。",
  "settings.agents.manage.validation.model.format": "请使用 provider/model 格式。",
  "settings.agents.manage.validation.steps.positive": "步骤数必须是正整数。",
