export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by SineCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in SineCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "SineCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in SineCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in SineCode.",
  ...
  "dialog.server.description": "Switch which SineCode server this app connects to.",
  ...
  "toast.update.description": "A new version of SineCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the SineCode team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, SineCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "SineCode includes free models so you can start immediately.",
  ...
  "app.name.desktop": "SineCode Desktop",
  ...
  "settings.desktop.wsl.description": "Run the SineCode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for SineCode",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how SineCode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether SineCode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how SineCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when SineCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of SineCode.",
  ...
  "settings.agents.description":
    "Manage main chat agents and specialist workers here. Hidden agents stay out of the main conversation surface.",
  "settings.agents.summary.main": "Main chat",
  "settings.agents.summary.specialists": "Specialists",
  "settings.agents.summary.hidden": "Hidden",
  "settings.agents.section.main.title": "Main chat agents",
  "settings.agents.section.main.description": "These agents stay available in the regular conversation workflow.",
  "settings.agents.section.specialists.title": "Specialist agents",
  "settings.agents.section.specialists.description":
    "These agents are reserved for delegated work and multi-agent execution flows.",
  "settings.agents.section.hidden.title": "Hidden agents",
  "settings.agents.section.hidden.description":
    "These agents are kept out of the main surface and only appear here for management.",
  "settings.agents.empty.main": "No main chat agents are available.",
  "settings.agents.empty.specialists": "No specialist agents are available.",
  "settings.agents.empty.hidden": "No hidden agents are configured.",
  "settings.agents.badge.native": "Built-in",
  "settings.agents.badge.hidden": "Hidden",
  "settings.agents.badge.mode.primary": "Primary",
  "settings.agents.badge.mode.all": "Shared",
  "settings.agents.badge.mode.subagent": "Specialist",
  "settings.agents.badge.variant": "Variant {{variant}}",
  "settings.agents.badge.steps": "{{count}} steps",
  "settings.agents.workspace.empty.title": "Open a workspace session to inspect agent settings",
  "settings.agents.workspace.empty.description":
    "Agent configuration is resolved per workspace. Open any project conversation first, then return here to inspect or tune the active agent set.",
  "settings.agents.detail.empty.title": "Select an agent",
  "settings.agents.detail.empty.description":
    "Choose an agent from the left to inspect its role, model, orchestration behavior, and future editable settings.",
  "settings.agents.detail.preview.title": "Configuration Preview",
  "settings.agents.detail.preview.description":
    "This detail pane is the base for the upcoming editable agent settings flow. Start by validating the information structure and field grouping.",
  "settings.agents.detail.section.identity": "Identity",
  "settings.agents.detail.section.model": "Model and reasoning",
  "settings.agents.detail.section.orchestration": "Orchestration and context",
  "settings.agents.detail.row.name": "Name",
  "settings.agents.detail.row.description": "Description",
  "settings.agents.detail.row.source": "Source",
  "settings.agents.detail.row.surface": "Surface placement",
  "settings.agents.detail.row.model": "Model",
  "settings.agents.detail.row.variant": "Variant",
  "settings.agents.detail.row.steps": "Step budget",
  "settings.agents.detail.row.invocation": "Invocation mode",
  "settings.agents.detail.row.autoPlan": "Available to auto-plan",
  "settings.agents.detail.row.directSelection": "Visible in manual selection",
  "settings.agents.detail.row.tools": "Tool profile",
  "settings.agents.detail.row.memory": "Memory profile",
  "settings.agents.detail.value.enabled": "Enabled",
  "settings.agents.detail.value.disabled": "Disabled",
  "settings.agents.detail.value.source.native": "Built-in template",
  "settings.agents.detail.value.source.custom": "Custom agent",
  "settings.agents.detail.value.surface.main": "Main conversation surface",
  "settings.agents.detail.value.surface.specialist": "Specialist only",
  "settings.agents.detail.value.surface.hidden": "Hidden from main surface",
  "settings.agents.detail.value.model.default": "Use workspace default model",
  "settings.agents.detail.value.steps.inherit": "Inherit workspace default",
  "settings.agents.detail.value.tools.workspaceDefault": "Follow workspace default tool policy",
  "settings.agents.detail.value.tools.customized": "Custom tool access policy",
  "settings.agents.detail.value.memory.conversation": "Session and project memory",
  "settings.agents.detail.value.memory.projectShared": "Project shared memory",
  "settings.agents.detail.value.memory.delegated": "Focused project and task memory",
  "settings.agents.detail.value.memory.disabled": "Disabled",
  "settings.agents.manage.open": "Edit agents",
  "settings.agents.manage.title": "Manage agents",
  "settings.agents.manage.description":
    "Modify existing agents, add custom agents, or disable agents that should not participate in your workspace.",
  "settings.agents.manage.add": "Add agent",
  "settings.agents.manage.listTitle": "Configured agents",
  "settings.agents.manage.custom": "Custom",
  "settings.agents.manage.new": "New agent",
  "settings.agents.manage.nativeReadonly": "Built-in agent",
  "settings.agents.manage.form.newDescription": "Create a new custom agent for this workspace.",
  "settings.agents.manage.form.nativeDescription":
    "Built-in agents can be overridden here. Deleting a built-in agent will disable it for this workspace.",
  "settings.agents.manage.form.customDescription": "Custom agents can be edited or removed from this workspace.",
  "settings.agents.manage.scopeNote": "Changes here apply only to the current workspace.",
  "settings.agents.manage.tab.identity": "Basics",
  "settings.agents.manage.tab.execution": "Execution",
  "settings.agents.manage.tab.memory": "Memory",
  "settings.agents.manage.overview.source": "Source",
  "settings.agents.manage.overview.mode": "Invocation",
  "settings.agents.manage.overview.surface": "Surface",
  "settings.agents.manage.overview.override.label": "Override status",
  "settings.agents.manage.overview.override.default": "Workspace default",
  "settings.agents.manage.overview.override.workspace": "Workspace override",
  "settings.agents.manage.overview.memory": "Memory",
  "settings.agents.manage.field.key.label": "Identifier",
  "settings.agents.manage.field.key.description": "Stable agent id used by orchestration and commands.",
  "settings.agents.manage.field.description.label": "Description",
  "settings.agents.manage.field.description.description": "Short description of when this agent should be used.",
  "settings.agents.manage.field.mode.label": "Mode",
  "settings.agents.manage.field.hidden.label": "Hide from main surface",
  "settings.agents.manage.field.hidden.description":
    "Hidden agents stay available to orchestration but will not appear in the main conversation selector.",
  "settings.agents.manage.field.model.label": "Model override",
  "settings.agents.manage.field.model.description": "Optional provider/model override for this agent.",
  "settings.agents.manage.field.variant.label": "Variant",
  "settings.agents.manage.field.variant.description": "Optional model variant for this agent.",
  "settings.agents.manage.field.steps.label": "Steps",
  "settings.agents.manage.field.steps.description": "Maximum step budget for this agent.",
  "settings.agents.manage.field.prompt.label": "System prompt override",
  "settings.agents.manage.field.prompt.description": "Optional prompt override for this agent.",
  "settings.agents.manage.field.memory.label": "Project memory access",
  "settings.agents.manage.field.memory.description":
    "Control whether this agent reads the workspace's shared memory when SineFlow orchestration is active.",
  "settings.agents.manage.field.memory.mode.inherit": "Inherit default behavior",
  "settings.agents.manage.field.memory.mode.projectShared": "Read project shared memory",
  "settings.agents.manage.field.memory.mode.disabled": "Do not read shared memory",
  "settings.agents.manage.field.memory.sourceTitle": "Shared memory source",
  "settings.agents.manage.field.memory.sourceDescription":
    "When enabled, SineFlow loads the first available shared memory file from the workspace.",
  "settings.agents.manage.field.memory.behaviorTitle": "Current behavior",
  "settings.agents.manage.field.memory.behaviorDescription":
    "This setting affects SineFlow auto-planning runs. It does not create a separate long-term memory store for each agent.",
  "settings.agents.manage.delete.nativeTitle": "Disable built-in agent",
  "settings.agents.manage.delete.nativeDescription":
    "This writes a workspace override that removes the built-in agent from the available list.",
  "settings.agents.manage.delete.customTitle": "Delete custom agent",
  "settings.agents.manage.delete.customDescription":
    "This writes a workspace override that removes the custom agent from the available list.",
  "settings.agents.manage.delete.disable": "Disable",
  "settings.agents.manage.delete.remove": "Delete",
  "settings.agents.manage.currentResolved": "Current resolved description",
  "settings.agents.manage.toast.saved.title": "Agent saved",
  "settings.agents.manage.toast.saved.description": "{{agent}} has been updated.",
  "settings.agents.manage.toast.saveFailed.title": "Failed to save agent",
  "settings.agents.manage.toast.deleted.title": "Agent removed",
  "settings.agents.manage.toast.deleted.description": "{{agent}} has been removed from this workspace.",
  "settings.agents.manage.toast.deleteFailed.title": "Failed to remove agent",
  "settings.agents.manage.validation.key.required": "Identifier is required.",
  "settings.agents.manage.validation.key.format":
    "Use lowercase letters, numbers, and dashes, and start with a letter or number.",
  "settings.agents.manage.validation.key.duplicate": "An agent with this identifier already exists.",
  "settings.agents.manage.validation.model.format": "Use provider/model format.",
  "settings.agents.manage.validation.steps.positive": "Steps must be a positive integer.",
