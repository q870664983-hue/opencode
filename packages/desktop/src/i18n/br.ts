export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do SineCode",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do SineCode foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentação do SineCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do SineCode está ausente. Tente reinstalar o aplicativo de desktop.",
