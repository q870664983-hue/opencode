export const dict = {
  ...
  "desktop.menu.help.documentation": "SineCode Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of SineCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of SineCode has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.error.sidecarMissing": "SineCode CLI binary is missing. Try reinstalling the desktop app.",
