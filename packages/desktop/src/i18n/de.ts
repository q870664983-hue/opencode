export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von SineCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von SineCode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.error.sidecarMissing":
    "Das SineCode CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
