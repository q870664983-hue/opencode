export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af SineCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af SineCode er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.menu.help.documentation": "SineCode Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing": "SineCode CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
