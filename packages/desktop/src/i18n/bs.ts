export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju SineCode-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} SineCode-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.menu.help.documentation": "SineCode Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka SineCode CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
