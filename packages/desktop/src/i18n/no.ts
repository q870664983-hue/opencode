export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av SineCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av SineCode er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.menu.help.documentation": "SineCode Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "SineCode CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
