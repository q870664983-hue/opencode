export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji SineCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} SineCode. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.menu.help.documentation": "Dokumentacja SineCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego SineCode CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
