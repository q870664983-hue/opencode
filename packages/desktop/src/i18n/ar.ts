export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من SineCode",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من SineCode، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.menu.help.documentation": "وثائق SineCode",
  ...
  "desktop.cli.error.sidecarMissing": "ملف SineCode CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
