export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'SineCode",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'SineCode a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.menu.help.documentation": "Documentation d'SineCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI SineCode est manquant. Essayez de réinstaller l'application de bureau.",
