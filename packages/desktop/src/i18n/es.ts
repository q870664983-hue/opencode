export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de SineCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de SineCode. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentación de SineCode",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de SineCode. Intenta reinstalar la aplicación de escritorio.",
